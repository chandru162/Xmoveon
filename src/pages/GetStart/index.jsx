...
const ContactSection = () => {
  ...
  return (
    <div className="bg-white min-h-screen py-10 px-40 font-sans">
      {/* ================= HEADER ================= */}
      <div className="mb-12">
      ...
      <div className="bg-[#111111] rounded-[35px] p-8 md:p-12 text-white mb-20 shadow-xl">
        ...
        <p className=" mb-10 max-w-xl text-sm leading-relaxed">
        ...
        <form className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <input
              ...
              className="bg-transparent border  rounded-full px-6 py-3.5 outline-none focus:border-[#8cf07b] transition text-sm"
            />
          ...
          {locations.map((loc, index) => (
            ...
            >
              <div className="relative z-10">
                ...
                <p className="text-sm leading-relaxed mt-2">{loc.address}</p>

                {loc.phone && <p className="font-semibold mt-1">{loc.phone}</p>}
              </div>
            </div>
          ))}
        </div>
