          ...
          <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
            ...
            <div className="w-full lg:w-1/2 flex flex-col items-center gap-6">
              ...
              <div className="w-full flex flex-col sm:flex-row gap-4 ">
                ...
                {/* CARD 1 */}
                <div className="relative flex-1 h-[90px] xl:h-[90px] lg:h-[70px] md:h-[110px]  rounded-[20px] overflow-hidden flex items-center px-4 ">
                  <img
                ...
                <div className="relative flex-1 h-[90px] xl:h-[90px] lg:h-[70px] md:h-[110px] rounded-[20px] overflow-hidden flex items-center px-4 ">
                  <img
                    ...
                    alt=""
                    className="absolute inset-0 h-[225px] w-full lg:w-full lg:h-full  md:w-full md:h-[110px] xl:w-full xl:h-[95px] object-cover"
                  />
