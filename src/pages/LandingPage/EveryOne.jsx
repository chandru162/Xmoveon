          ...
          {cards.map((item, index) => (
            ...
            >
              ...
              <div className="p-5 flex flex-col gap-2 flex-1">
                ...
                <h3 className="text-sm sm:text-base lg:text-md font-semibold">
                  {item.title}
                </h3>
