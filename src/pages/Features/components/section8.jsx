    ...
    <section className="w-full  py-12 md:py-20 px-6 md:px-16 lg:px-20 xl:px-24 ">
      <div className="max-w-[1440px] mx-auto text-center md:text-left">
        ...
        <h2 className=" text-[26px]
                      ...
                      xl:text-[52px]
                      font-semibold
                      leading-[1.15] mb-12 md:mb-20">
          Technology That <br className="hidden sm:block" />
          <span className="bg-[#E4FFD4] px-0 md:px-0 py-1 rounded-t-[18px] md:rounded-t-[25px] rounded-br-[18px] md:rounded-br-[25px] inline-block mt-2">
            Drives Xmoveon
          </span>
          Taxi
        </h2>
